...
public class Tileset {
    ...
    public static final TETile AVATAR_A = new TETile('@', Color.MAGENTA, Color.black, "Player A", 14);
    public static final TETile AVATAR_B = new TETile('@', Color.ORANGE, Color.black, "Player B", 13);
