...
public class Main {
    ...
    public static final String HYPONYMS_11_FILE = PREFIX + "hyponyms_size11.txt";
    public static final String SYNSETS_SIZE11_FILE = PREFIX + "synsets_size11.txt";
    ...
    public static void main(String[] args) {
        ...
        hns.startUp();
        // modify HyponymsHandler
        hns.register("hyponyms", new HyponymsHandler(WORD_HISTORY_SIZE14377_FILE, YEAR_HISTORY_FILE, SYNSETS_SIZE82191_FILE, HYPONYMS_SIZE82191_FILE));
