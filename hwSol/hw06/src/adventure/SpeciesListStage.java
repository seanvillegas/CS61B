...
public class SpeciesListStage implements AdventureStage {
    ...
    public String nextStagePrompt() {
        return "Wow! That was pretty neat! We got to see so many neat animals! " + "We should study now, so let's go to the Woz.";
    }
    ...
    public static int arraySimilarity(List<String> listOne, List<String> listTwo) {
        ...
        // Bug 3 need to have condition when listOne.size is equal to 0
        if (listOne.size() == 0) {
            return 0;
        } else {
