...
public class BeeCountingStage implements AdventureStage {
    ...
    // First Bug, need to instantiate a ArrayList object to store the elements
    ...
    public String nextStagePrompt() {
        return "Phew, that was a lot of counting! It's time for Professor Hug's office hours! " + "Let's head up to his office on the 7th floor.";
    }
    ...
    private int sumInput() {
        int sum = 0;
        // Bug 2 is the way the loop increments <= in the for loop, changed it to <
