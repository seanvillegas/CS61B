...
public class PercolationTest {
    ...
    public void randomCountCheck() {
        ...
        // call open again. Expected output is that it will do it but not increment count
        p.open(0, 1);
        assertEquals(6, p.numberOfOpenSites());
    }
    ...
    public void nonOOBN() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            Percolation p = new Percolation(N); // This line is expected to throw IllegalArgumentException
        });
    }

    @Test
    public void nonOOBRow() {
        int N = 5;
        Percolation p = new Percolation(N);
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {
            p.open(-1, 1); // This line is expected to throw IndexOutOfBoundsException
        });
    }

    @Test
    public void nonOOBCol() {
        int N = 5;
        Percolation p = new Percolation(N);
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {
            p.open(1, -500); // This line is expected to throw IndexOutOfBoundsException
        });
    }
}
